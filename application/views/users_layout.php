...
<div class="container-fluid">
    ...
    <div class="btn-group-vertical" style="position:fixed; z-index:2;">
            <a href="<?php echo CONF_BASE_PATH ?>/applications/list/<?php echo $session['user_id'] ?>" class="btn btn-primary">Applications</a>
            ...
            <a href="<?php echo CONF_BASE_PATH?>/session/logout" class="btn btn-primary">Sign Out</a>	
        </div>
        ...
        <div style="background-color :#680303 " id="strip"><p><h2 id="title">WELCOME</h2></p>
            <p style=" text-align:center;color:white;font-size:20px;"><?php echo $session['first_name'].' to Event Manager !'?></p>
        </div>
    </div>  
